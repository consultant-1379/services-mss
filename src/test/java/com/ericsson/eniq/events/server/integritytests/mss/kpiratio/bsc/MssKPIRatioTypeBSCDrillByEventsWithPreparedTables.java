 ...
 *
 */
public class MssKPIRatioTypeBSCDrillByEventsWithPreparedTables extends
    ...
    @Test
    public void testTypeBSCDrilltypeEvents_Voice_RAW() throws Exception {
    ...
    @Test
    public void testTypeBSCDrilltypeEvents_Loc_RAW() throws Exception {
        final String timestamp = DateTimeUtilities.getDateTimeMinusMinutes(15);
    ...
    @Test
    public void testTypeBSCDrilltypeEvents_Sms_RAW() throws Exception {
        final String timestamp = DateTimeUtilities.getDateTimeMinusMinutes(15);
