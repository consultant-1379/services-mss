 ...
 *
 */
public class MssKPIRatioTypeBSCDrillByBSCWithPreparedTablesAggTest extends
    ...
    @Test
    public void testTypeBSCDrilltypeBSC_LOC_Agg_15MIN() throws Exception {
    ...
    @Test
    public void testTypeBSCDrilltypeBSC_LOC_Agg_DAY() throws Exception {
    ...
    @Test
    public void testTypeBSCDrilltypeBSC_SMS_msOriginating_Agg_15MIN() throws Exception {
        final String timestamp = DateTimeUtilities.getDateTimeMinusHours(3);
    ...
    @Test
    public void testTypeBSCDrilltypeBSC_SMS_msOriginating_Agg_DAY() throws Exception {
        final String timestamp = DateTimeUtilities.getDateTimeMinus48Hours();
        final String eventId = MSS_SMS_MS_ORIGINATING_EVENT_ID;
        final String eventType = TEST_VALUE_EVENT_TYPE_SMS_MS_ORIGINATING;
        final int noOfErrors = 1;
    ...
    @Test
    public void testTypeBSCDrilltypeBSC_Voice_Agg_15MIN() throws Exception {
        final String timestamp = DateTimeUtilities.getDateTimeMinusHours(3);
    ...
    @Test
    public void testTypeBSCDrilltypeBSC_Voice_Agg_DAY() throws Exception {
        final String timestamp = DateTimeUtilities.getDateTimeMinus48Hours();
        final String eventId = MSS_MS_ORIGINATING_EVENT_ID;
        final String eventType = TEST_VALUE_EVENT_TYPE_MS_ORIGINATING;
        final int noOfErrors = 2;
