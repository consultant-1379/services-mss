...
public class MssVoiceServiceSummaryQueryCreatorTest extends QueryConstructorBaseTestClass {

    MssVoiceServiceSummaryQueryCreator testObj;
    ...
    @Before
    public void onSetUp() {
        testObj = new MssVoiceServiceSummaryQueryCreator();
    ...
    @Test
    public void testGetMssSummaryQueryForRawTAC() {
    ...
    @Test
    public void testGetMssSummaryQueryForRawMan() {
    ...
    @Test
    public void testGetMssSummaryQueryForRawController() {
    ...
    @Test
    public void testGetMssSummaryQueryForRawAccessArea() {
    ...
    @Test
    public void testGetMssSummaryQueryForRawEventSrc() {
    ...
    @Test
    public void testGetMssSummaryQueryForGroupRawEventSrc() {
        params.put(TYPE_PARAM, MSC_PARAM.toUpperCase());
    ...
    @Test
    public void testGetMssSummaryQueryForGroupRawTAC() {
        params.put(TYPE_PARAM, TAC_PARAM.toUpperCase());
    ...
    @Test
    public void testGetMssSummaryQueryForGroupRawController() {
        params.put(TYPE_PARAM, BSC_PARAM.toUpperCase());
    ...
    @Test
    public void testGetMssSummaryQueryForGroupRawAccessArea() {
        params.put(TYPE_PARAM, CELL_PARAM.toUpperCase());
    ...
    @Test
    public void testGetMssSummaryQueryForGroupSummaryDrillDownRawController() {
        params.put(TYPE_PARAM, BSC_PARAM.toUpperCase());
        params.put(GROUP_NAME_KEY, "bscGroup");
        params.put(EVENT_ID_PARAM, "0");
        final String sql = testObj.createQuery(params);
        System.out.println(sql);
        assertNotNull(sql);
    }
    ...
    @Test
    public void testGetMssSummaryQueryForGroupSummaryDrillDownRawEventSrc() {
        params.put(TYPE_PARAM, MSC_PARAM.toUpperCase());
        params.put(GROUP_NAME_KEY, "mscGroup");
        params.put(EVENT_ID_PARAM, "0");
        final String sql = testObj.createQuery(params);
    ...
    @Test
    public void testGetMssSummaryQueryForGroupSummaryDrillDownRawAccessArea() {
        params.put(TYPE_PARAM, CELL_PARAM.toUpperCase());
        params.put(GROUP_NAME_KEY, "cellGroup");
        params.put(EVENT_ID_PARAM, "0");
        final String sql = testObj.createQuery(params);
