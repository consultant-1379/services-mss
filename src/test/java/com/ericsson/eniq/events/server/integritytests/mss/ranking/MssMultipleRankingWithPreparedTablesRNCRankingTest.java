...
import com.ericsson.eniq.events.server.test.queryresults.mss.MssMultipleRankingRNCResult;
import com.ericsson.eniq.events.server.test.stubs.DummyUriInfoImpl;
import com.ericsson.eniq.events.server.test.util.DateTimeUtilities;
import com.sun.jersey.core.util.MultivaluedMapImpl;

public class MssMultipleRankingWithPreparedTablesRNCRankingTest extends
        MssTestsWithTemporaryTablesBaseTestCase<MssMultipleRankingRNCResult> {
    ...
    private void populateTopologyTablesForQuery() throws SQLException {
        ...
        values.put(RAT, RAT_FOR_3G);
        values.put(RAT_DESC, _3G);
    ...
    private void validateResultFromTables(final List<MssMultipleRankingRNCResult> results) {
        assertThat(results.size(), is(1));
        final MssMultipleRankingRNCResult result = results.get(0);
        assertThat(result.getHier3Id(), is(String.valueOf(TEST_VALUE_MSS_HIER3_ID)));
        assertThat(result.getRank(), is(1));
        assertThat(result.getRatDesc(), is(_3G));
        assertThat(result.getRat(), is(RAT_FOR_3G));
    ...
    @Test
    public void testRNCBlockRankingRaw() throws Exception {
        ...
        final List<MssMultipleRankingRNCResult> summaryResult = getTranslator().translateResult(json,
                MssMultipleRankingRNCResult.class);

        validateResultFromTables(summaryResult);
    }

    @Test
    public void testRNCDropRankingRaw() throws Exception {
        final String timestamp = DateTimeUtilities.getDateTimeMinusMinutes(4);
    ...
    @Test
    public void testRNCBlockRanking15Min() throws Exception {
        final String timestamp = DateTimeUtilities.getDateTimeMinusHours(3);

        final String errTable = TEMP_EVENT_E_MSS_VOICE_VEND_HIER3_ERR_15MIN;
        final String sucTable = TEMP_EVENT_E_MSS_VOICE_VEND_HIER3_SUC_15MIN;
    ...
    @Test
    public void testRNCDropRanking15Min() throws Exception {
        final String timestamp = DateTimeUtilities.getDateTimeMinusHours(3);

        final String errTable = TEMP_EVENT_E_MSS_VOICE_VEND_HIER3_DROP_CALL_15MIN;
        final String sucTable = TEMP_EVENT_E_MSS_VOICE_VEND_HIER3_SUC_15MIN;
    ...
    @Test
    public void testRNCBlockRankingDAY() throws Exception {
        final String timestamp = DateTimeUtilities.getDateTimeMinusHours(48);

        final String errTable = TEMP_EVENT_E_MSS_VOICE_VEND_HIER3_ERR_DAY;
        final String sucTable = TEMP_EVENT_E_MSS_VOICE_VEND_HIER3_SUC_DAY;
    ...
    @Test
    public void testRNCDropRankingDAY() throws Exception {
        final String timestamp = DateTimeUtilities.getDateTimeMinusHours(48);

        final String errTable = TEMP_EVENT_E_MSS_VOICE_VEND_HIER3_DROP_CALL_DAY;
        final String sucTable = TEMP_EVENT_E_MSS_VOICE_VEND_HIER3_SUC_DAY;
