...
import com.ericsson.eniq.events.server.test.queryresults.mss.MssMultipleRankingAccessAreaResult;
import com.ericsson.eniq.events.server.test.stubs.DummyUriInfoImpl;
import com.ericsson.eniq.events.server.test.util.DateTimeUtilities;
import com.sun.jersey.core.util.MultivaluedMapImpl;

public class MssMultipleRankingWithPreparedTablesAccessAreaRankingTest extends
        MssTestsWithTemporaryTablesBaseTestCase<MssMultipleRankingAccessAreaResult> {
    ...
    private void validateResultFromTables(final List<MssMultipleRankingAccessAreaResult> results) {
        assertThat(results.size(), is(1));
        final MssMultipleRankingAccessAreaResult result = results.get(0);
        ...
        assertThat(result.getRat(), is(String.valueOf(RAT_FOR_GSM)));
        assertThat(result.getRanVendor(), is(ERICSSON));
        ...
        assertThat(result.getFailures(), is(String.valueOf(1)));
        assertThat(result.getSuccesses(), is(String.valueOf(1)));
    }
    ...
    @Test
    public void testCELLBlockRankingRaw() throws Exception {
        ...
        final List<MssMultipleRankingAccessAreaResult> summaryResult = getTranslator().translateResult(json,
                MssMultipleRankingAccessAreaResult.class);

        validateResultFromTables(summaryResult);
    }

    @Test
    public void testCELLDropRankingRaw() throws Exception {
        final String timestamp = DateTimeUtilities.getDateTimeMinusMinutes(4);
    ...
    @Test
    public void testCELLBlockRanking15Min() throws Exception {
        final String timestamp = DateTimeUtilities.getDateTimeMinusHours(3);

        final String errTable = TEMP_EVENT_E_MSS_VOICE_VEND_HIER321_ERR_15MIN;
        final String sucTable = TEMP_EVENT_E_MSS_VOICE_VEND_HIER321_SUC_15MIN;
    ...
    @Test
    public void testCELLDropRanking15Min() throws Exception {
        final String timestamp = DateTimeUtilities.getDateTimeMinusHours(3);

        final String errTable = TEMP_EVENT_E_MSS_VOICE_VEND_HIER321_DROP_CALL_15MIN;
        final String sucTable = TEMP_EVENT_E_MSS_VOICE_VEND_HIER321_SUC_15MIN;
    ...
    @Test
    public void testCELLBlockRankingDAY() throws Exception {
        final String timestamp = DateTimeUtilities.getDateTimeMinusHours(48);

        final String errTable = TEMP_EVENT_E_MSS_VOICE_VEND_HIER321_ERR_DAY;
        final String sucTable = TEMP_EVENT_E_MSS_VOICE_VEND_HIER321_SUC_DAY;
    ...
    @Test
    public void testCELLDropRankingDAY() throws Exception {
        final String timestamp = DateTimeUtilities.getDateTimeMinusHours(48);

        final String errTable = TEMP_EVENT_E_MSS_VOICE_VEND_HIER321_DROP_CALL_DAY;
        final String sucTable = TEMP_EVENT_E_MSS_VOICE_VEND_HIER321_SUC_DAY;
