 ...
 *
 */
public class MssKPIRatioTypeMSCDrillByBSCWithPreparedTablesRawTest extends
    ...
    @Test
    public void testTypeMSCDrilltypeMSC_SMS_RAW() throws Exception {
        final String timestamp = DateTimeUtilities.getDateTimeMinusMinutes(15);
    ...
    @Test
    public void testTypeMSCDrilltypeMSC_Voice_RAW() throws Exception {
        final String timestamp = DateTimeUtilities.getDateTimeMinusMinutes(15);
