...
public class MSSPieChartCauseCodeAnalysisWithPreparedTablesTest extends
        MssTestsWithTemporaryTablesBaseTestCase<PieChartCauseCodeAnalysisMSSResult> {
    ...
    public void testGetCauseCodeAnalysisByMSC() throws Exception {
        ...
        final List<PieChartCauseCodeAnalysisMSSResult> result = getResults(MSS + UNDERSCORE + CAUSE_CODE_PIE_CHART
    ...
    private List<PieChartCauseCodeAnalysisMSSResult> getResults(final String path) throws Exception {
        final String json = mssCauseCodeAnalysisPieChartResource.getResults(path);
        System.out.println(json);
        return getTranslator().translateResult(json, PieChartCauseCodeAnalysisMSSResult.class);
    }
}