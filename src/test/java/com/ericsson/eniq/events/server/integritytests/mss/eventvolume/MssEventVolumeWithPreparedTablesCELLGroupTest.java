 ...
 *
 */
public class MssEventVolumeWithPreparedTablesCELLGroupTest extends
    ...
    private void createSMSRawTablesAndPopulateData(final Connection connection1, final String sucTable,
        ...
        populateCELLGroupData(connection1);
    }
    ...
    private void createCELLGroupTable(final Connection connection1) throws Exception {
        ...
        new SQLCommand(connection1).createTemporaryTableMss(TEMP_GROUP_TYPE_E_RAT_VEND_HIER321, columnsForRawTable);
    }

    private void populateCELLGroupData(final Connection connection1) throws SQLException {
        final Map<String, Object> values = new HashMap<String, Object>();
        values.put(HIER321_ID, TEST_VALUE_MSS_HIER321_ID);
        values.put(GROUP_NAME, TEST_VALUE_MSS_GROUP_CELL);

        new SQLCommand(connection1).insertRow(TEMP_GROUP_TYPE_E_RAT_VEND_HIER321, values);
    }
    ...
    private void createVoiceRawTables(final Connection connection1, final String sucTable, final String errTable,
        ...
        createCELLGroupTable(connection1);
    }
    ...
    @Test
    public void testGetEventVolumeDataTypeCELLGroupRaw() throws Exception {
    ...
    @Test
    public void testGetEventVolumeDataTypeCELLGroup15MIN() throws Exception {
    ...
    @Test
    public void testGetEventVolumeDataTypeCELLGroupDAY() throws Exception {
