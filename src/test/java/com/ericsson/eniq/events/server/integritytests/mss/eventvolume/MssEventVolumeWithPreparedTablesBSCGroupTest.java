 ...
 *
 */
public class MssEventVolumeWithPreparedTablesBSCGroupTest extends
    ...
    private void createImpactedIMSITables(final Connection connection1) throws Exception {
        ...
        createBSCGroupTable(connection1);
    }
    ...
    private void createAggTableAndPopulateAggData15MIN(final String timestamp) throws Exception {
        ...
        //2. Create SMS Tables and populate data for test
        createSMSAggTablesAndPopulateData(conn1, TEMP_SMS_VEND_HIER3_EVENTID_SUC_15MIN,
                TEMP_SMS_VEND_HIER3_EVENTID_ERR_15MIN, timestamp);
        ...
        //4. Create Voice Tables and populate data for test
        createVoiceAggTablesAndPopulateData(conn3, TEMP_VOICE_VEND_HIER3_EVENTID_SUC_15MIN,
                TEMP_VOICE_VEND_HIER3_EVENTID_ERR_15MIN, TEMP_VOICE_VEND_HIER3_EVENTID_DROP_15MIN, timestamp);
    }
    ...
    private void createAggTableAndPopulateAggDataDAY(final String timestamp) throws Exception {
        ...
        //2. Create SMS Tables and populate data for test
        createSMSAggTablesAndPopulateData(conn1, TEMP_SMS_VEND_HIER3_EVENTID_SUC_DAY,
                TEMP_SMS_VEND_HIER3_EVENTID_ERR_DAY, timestamp);
        ...
        //4. Create Voice Tables and populate data for test
        createVoiceAggTablesAndPopulateData(conn3, TEMP_VOICE_VEND_HIER3_EVENTID_SUC_DAY,
                TEMP_VOICE_VEND_HIER3_EVENTID_ERR_DAY, TEMP_VOICE_VEND_HIER3_EVENTID_DROP_DAY, timestamp);
    }
    ...
    private void createBSCGroupTable(final Connection connection1) throws Exception {
        final Collection<String> columnsForRawTable = new ArrayList<String>();
        columnsForRawTable.add(HIER3_ID);
        columnsForRawTable.add(GROUP_NAME);
        new SQLCommand(connection1).createTemporaryTableMss(TEMP_GROUP_TYPE_E_RAT_VEND_HIER3, columnsForRawTable);
    }

    private void populateBSCGroupData(final Connection connection1) throws SQLException {
        final Map<String, Object> values = new HashMap<String, Object>();
        values.put(HIER3_ID, TEST_VALUE_MSS_HIER3_ID);
        values.put(GROUP_NAME, TEST_VALUE_MSS_CONTROLLER_NAME);

        new SQLCommand(connection1).insertRow(TEMP_GROUP_TYPE_E_RAT_VEND_HIER3, values);
    }
    ...
    private void createSMSRawTablesAndPopulateData(final Connection connection1, final String sucTable,
        ...
        populateBSCGroupData(connection1);
    }
    ...
    private String getJsonString(final String dataFrom, final String dataTo, final String timefrom, final String timeTo)
        ...
        map.putSingle(GROUP_NAME_PARAM, TEST_VALUE_MSS_CONTROLLER_NAME);
    ...
    @Test
    public void testGetEventVolumeDataTypeBSCGroupRaw() throws Exception {
    ...
    @Test
    public void testGetEventVolumeDataTypeBSCGroup15MIN() throws Exception {
    ...
    @Test
    public void testGetEventVolumeDataTypeBSCGroupDAY() throws Exception {
