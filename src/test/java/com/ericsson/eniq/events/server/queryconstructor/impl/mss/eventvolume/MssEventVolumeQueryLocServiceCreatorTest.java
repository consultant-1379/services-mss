...
public class MssEventVolumeQueryLocServiceCreatorTest extends QueryConstructorBaseTestClass {

    private MssEventVolumeQueryLocServiceCreator testObj;

    private Map<String, Object> params;

    @Before
    public void onSetUp() {
        testObj = new MssEventVolumeQueryLocServiceCreator();
