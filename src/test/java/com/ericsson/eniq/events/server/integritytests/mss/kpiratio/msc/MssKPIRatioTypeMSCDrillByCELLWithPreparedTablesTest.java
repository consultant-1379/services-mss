 ...
 *
 */
public class MssKPIRatioTypeMSCDrillByCELLWithPreparedTablesTest extends
    ...
    private void validateResultFromTables(final List<MssKPIRatioDrillTypeCELLResult> results, final String eventId,
        ...
        assertThat(result.getEventsrcId(), is(String.valueOf(TEST_VALUE_MSS_EVNTSRC_ID)));
    ...
    @Test
    public void testTypeMSCDrilltypeCELL_RAW() throws Exception {
