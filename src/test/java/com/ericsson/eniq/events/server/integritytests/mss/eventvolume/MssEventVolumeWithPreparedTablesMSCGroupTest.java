 ...
 *
 */
public class MssEventVolumeWithPreparedTablesMSCGroupTest extends
    ...
    private void createImpactedIMSITables(final Connection connection1) throws Exception {
        ...
        createMSCGroupTable(connection1);
    }
    ...
    private void createSMSRawTablesAndPopulateData(final Connection connection1, final String sucTable,
        ...
        populateMSCGroupData(connection1);
    }
    ...
    private void createMSCGroupTable(final Connection connection1) throws Exception {
        final Collection<String> columnsForRawTable = new ArrayList<String>();
        columnsForRawTable.add(EVNTSRC_ID);
        columnsForRawTable.add(GROUP_NAME);
        new SQLCommand(connection1).createTemporaryTableMss(TEMP_GROUP_TYPE_E_EVNTSRC_CS, columnsForRawTable);
    }

    private void populateMSCGroupData(final Connection connection1) throws SQLException {
        final Map<String, Object> values = new HashMap<String, Object>();
        values.put(EVNTSRC_ID, TEST_VALUE_MSS_EVNTSRC_ID);
        values.put(GROUP_NAME, TEST_VALUE_MSS_GROUP_EVNTSRC);

        new SQLCommand(connection1).insertRow(TEMP_GROUP_TYPE_E_EVNTSRC_CS, values);
    }
    ...
    private void createAggTableAndPopulateAggData15MIN(final String timestamp) throws Exception {
        ...
        //2. Create SMS Tables and populate data for test
        createSMSAggTablesAndPopulateData(conn1, TEMP_SMS_EVNTSRC_EVENTID_SUC_15MIN,
                TEMP_SMS_EVNTSRC_EVENTID_ERR_15MIN, timestamp);

        //3. Create Location Service Tables and populate data for test
        createLocAggTablesAndPopulateData(conn2, TEMP_LOC_EVENT_SRC_SUM_SUC_15MIN, TEMP_LOC_EVENT_SRC_SUM_ERR_15MIN,
                timestamp);

        //4. Create Voice Tables and populate data for test
        createVoiceAggTablesAndPopulateData(conn3, TEMP_VOICE_EVENT_SRC_SUM_SUC_15MIN,
    ...
    private void createAggTableAndPopulateAggDataDAY(final String timestamp) throws Exception {
        ...
        //2. Create SMS Tables and populate data for test
        createSMSAggTablesAndPopulateData(conn1, TEMP_SMS_EVNTSRC_EVENTID_SUC_DAY, TEMP_SMS_EVNTSRC_EVENTID_ERR_DAY,
                timestamp);

        //3. Create Location Service Tables and populate data for test
        createLocAggTablesAndPopulateData(conn2, TEMP_LOC_EVENT_SRC_SUM_SUC_DAY, TEMP_LOC_EVENT_SRC_SUM_ERR_DAY,
                timestamp);

        //4. Create Voice Tables and populate data for test
        createVoiceAggTablesAndPopulateData(conn3, TEMP_VOICE_EVENT_SRC_SUM_SUC_DAY, TEMP_VOICE_EVENT_SRC_SUM_ERR_DAY,
    ...
    private void validateResultFromTablesDayAgg(final List<MssEventVolumeWithTypeResult> results) {
    ...
    @Test
    public void testGetEventVolumeDataTypeMSCGroupRaw() throws Exception {
    ...
    @Test
    public void testGetEventVolumeDataTypeMSCGroup15MIN() throws Exception {
    ...
    @Test
    public void testGetEventVolumeDataTypeMSCGroupDAY() throws Exception {
