...
import com.ericsson.eniq.events.server.test.queryresults.mss.MssMultipleRankingTerminalResult;
import com.ericsson.eniq.events.server.test.stubs.DummyUriInfoImpl;
import com.ericsson.eniq.events.server.test.util.DateTimeUtilities;
import com.sun.jersey.core.util.MultivaluedMapImpl;

public class MssMultipleRankingWithPreparedTablesTerminalVoiceRankingTest extends
        MssTestsWithTemporaryTablesBaseTestCase<MssMultipleRankingTerminalResult> {
    ...
    private void validateResultFromTables(final List<MssMultipleRankingTerminalResult> results) {
        assertThat(results.size(), is(1));
        final MssMultipleRankingTerminalResult result = results.get(0);
        assertThat(result.getRank(), is(1));
        assertThat(result.getManufacturer(), is(String.valueOf(TEST_VALUE_MANUFACTURER)));
        assertThat(result.getMarketingName(), is(TEST_VALUE_MARKETING_NAME));
    ...
    @Test
    public void testTACBlockRankingRaw() throws Exception {
        ...
        final List<MssMultipleRankingTerminalResult> summaryResult = getTranslator().translateResult(json,
                MssMultipleRankingTerminalResult.class);

        validateResultFromTables(summaryResult);
    }

    @Test
    public void testTACDropRankingRaw() throws Exception {
        final String timestamp = DateTimeUtilities.getDateTimeMinusMinutes(4);
    ...
    @Test
    public void testTACBlockRanking15Min() throws Exception {
        final String timestamp = DateTimeUtilities.getDateTimeMinusHours(3);

        final String errTable = TEMP_EVENT_E_MSS_VOICE_MANUF_TAC_ERR_15MIN;
        final String sucTable = TEMP_EVENT_E_MSS_VOICE_MANUF_TAC_SUC_15MIN;
    ...
    @Test
    public void testTACDropRanking15Min() throws Exception {
        final String timestamp = DateTimeUtilities.getDateTimeMinusHours(3);

        final String errTable = TEMP_EVENT_E_MSS_VOICE_MANUF_TAC_DROP_CALL_15MIN;
        final String sucTable = TEMP_EVENT_E_MSS_VOICE_MANUF_TAC_SUC_15MIN;
    ...
    @Test
    public void testTACBlockRankingDAY() throws Exception {
        final String timestamp = DateTimeUtilities.getDateTimeMinusHours(48);

        final String errTable = TEMP_EVENT_E_MSS_VOICE_MANUF_TAC_ERR_DAY;
        final String sucTable = TEMP_EVENT_E_MSS_VOICE_MANUF_TAC_SUC_DAY;
    ...
    @Test
    public void testTACDropRankingDAY() throws Exception {
        final String timestamp = DateTimeUtilities.getDateTimeMinusHours(48);

        final String errTable = TEMP_EVENT_E_MSS_VOICE_MANUF_TAC_DROP_CALL_DAY;
        final String sucTable = TEMP_EVENT_E_MSS_VOICE_MANUF_TAC_SUC_DAY;
