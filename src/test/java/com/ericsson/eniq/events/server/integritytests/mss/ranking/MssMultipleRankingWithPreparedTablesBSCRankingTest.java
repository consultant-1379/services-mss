...
import com.ericsson.eniq.events.server.test.queryresults.mss.MssMultipleRankingBSCResult;
import com.ericsson.eniq.events.server.test.stubs.DummyUriInfoImpl;
import com.ericsson.eniq.events.server.test.util.DateTimeUtilities;
import com.sun.jersey.core.util.MultivaluedMapImpl;

public class MssMultipleRankingWithPreparedTablesBSCRankingTest extends
        MssTestsWithTemporaryTablesBaseTestCase<MssMultipleRankingBSCResult> {
    ...
    private void validateResultFromTables(final List<MssMultipleRankingBSCResult> results) {
        assertThat(results.size(), is(1));
        final MssMultipleRankingBSCResult result = results.get(0);
    ...
    @Test
    public void testBSCBlockRankingRaw() throws Exception {
        ...
        final List<MssMultipleRankingBSCResult> summaryResult = getTranslator().translateResult(json,
                MssMultipleRankingBSCResult.class);

        validateResultFromTables(summaryResult);
    }

    @Test
    public void testBSCDropRankingRaw() throws Exception {
        final String timestamp = DateTimeUtilities.getDateTimeMinusMinutes(4);
    ...
    @Test
    public void testBSCBlockRanking15Min() throws Exception {
    ...
    @Test
    public void testBSCDropRanking15Min() throws Exception {
        final String timestamp = DateTimeUtilities.getDateTimeMinusHours(3);
    ...
    @Test
    public void testBSCBlockRankingDAY() throws Exception {
    ...
    @Test
    public void testBSCDropRankingDAY() throws Exception {
        final String timestamp = DateTimeUtilities.getDateTimeMinusHours(48);
