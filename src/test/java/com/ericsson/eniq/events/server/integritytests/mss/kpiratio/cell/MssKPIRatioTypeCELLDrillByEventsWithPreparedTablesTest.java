 ...
 *
 */
public class MssKPIRatioTypeCELLDrillByEventsWithPreparedTablesTest extends
    ...
    @Test
    public void testTypeCELLDrilltypeEvents_Voice_RAW() throws Exception {
    ...
    @Test
    public void testTypeCELLDrilltypeEvents_Loc_RAW() throws Exception {
        final String timestamp = DateTimeUtilities.getDateTimeMinusMinutes(15);
    ...
    @Test
    public void testTypeCELLDrilltypeEvents_Sms_RAW() throws Exception {
        final String timestamp = DateTimeUtilities.getDateTimeMinusMinutes(15);
